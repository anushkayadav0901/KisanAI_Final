      ...
      <div className="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mt-10">
              ...
              <Link
                key={entry.href}
                to={entry.href}
                className="group p-6 rounded-2xl bg-white/10 border border-white/20 hover:bg-white transition-colors"
              >
                <entry.icon className="w-6 h-6 text-[#FDE7B3] group-hover:text-[#63A361] transition-colors" />
                <p className="text-white font-semibold text-base mt-3 group-hover:text-[#5B532C] transition-colors">
                  {entry.label}
                </p>
